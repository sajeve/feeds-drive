...
public class DownloadAndSaveFileTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	static final ICancellation cancellation = new ICancellation() {
		@Override
	...
	public void testDownloadHtmlToFile() throws IOException {
		...
		{
			InputStream input = NetworkUtils.getStreamFromUrl(address, NetworkUtils.MOBILE_USER_AGENT, cancellation);
    ...
    public void testEmptyCase() throws IOException {
		InputStream input = NetworkUtils.getStreamFromUrl("http://kinhdoanh.vnexpress.net/tin-tuc/ebank/sap-nhap-ngan-hang-yeu-co-khien-kho-khan-bi-cong-don-2985213.html", NetworkUtils.MOBILE_USER_AGENT, cancellation);
	...
	public void testGetRssItem() throws FeedParserException, IOException {
		...
		List<FeedItem> items = contentParser.parseFeeds("http://vnexpress.net/rss/thoi-su.rss", "UTF-8", cancellation);

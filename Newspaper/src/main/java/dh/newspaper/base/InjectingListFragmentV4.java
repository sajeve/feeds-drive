 ...
 */
public class InjectingListFragmentV4
    ...
    public void onAttach(final Activity activity) {
        ...
        mObjectGraph = ((Injector) activity).getObjectGraph().plus(getModulesPlusSelf().toArray());
	...
	private List<Object> getModulesPlusSelf() {
		...
		result.add(new InjectingFragmentModuleV4(this, this));
		return result;
	}
}

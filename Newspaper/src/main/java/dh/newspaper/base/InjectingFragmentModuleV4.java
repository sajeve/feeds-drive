...
/**
 * The dagger module associated with {@link InjectingFragmentV4} and {@link InjectingListFragmentV4}.
 */
@Module(library=true)
public class InjectingFragmentModuleV4 {
     ...
     */    public InjectingFragmentModuleV4(android.support.v4.app.Fragment fragment, Injector injector) {
        mFragment = fragment;
        mInjector = injector;
    }

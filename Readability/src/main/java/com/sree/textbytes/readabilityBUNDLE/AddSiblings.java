...
public class AddSiblings {
	...
	public static Element addSiblings(Element node, String lang) {
		...
		if(nextSibling != null) {
			...
			int baseLineScoreForNextSibling = getBaselineScoreForSiblings(nextSibling, lang);
	 ...
	 * @return
	 */
	private static int getBaselineScoreForSiblings(Element topNode, String lang) {
		int base = 100000;

...
public class GooseExtractor {
	...
	public Element fetchArticleContent(Document document, String lang) {
		return calculateBestNodeBasedOnClustering(document, lang);
	}
	 ...
	 * @return
	 */
	private Element calculateBestNodeBasedOnClustering(Document doc, String lang) {
		...
		if(topNode != null) {
			topNode = AddSiblings.addSiblings(topNode, lang);
		}
	 ...
	 * @return
	 */
	private boolean isOkToBoost(Element node, String lang) {
		int stepsAway = 0;
